...
- [ ] MVI: формализовать intents/state/effects, убрать прямые вызовы ViewModel из UI где возможно.
- [ ] ViewModels: разделить ответственность FeedViewModel и ArticleViewModel.
